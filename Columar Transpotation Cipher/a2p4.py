...
def decryptMystery():
    # read the file
    file = open("mystery.txt", "r", encoding="utf8")
    line = file.read()
    file.close()
    
    # decrypt the message
    plaintext = decryptMessage([8,1,6,2,10,4,5,3,7,9], line)
    #print(plaintext)
    
    # write the output into the text file
    file2 = open("mystery.dec.txt", "w", encoding="utf8")
